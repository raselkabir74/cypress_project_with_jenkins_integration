...
MochaJUnitReporter.prototype.getTestcaseData = function(test, err) {
  ...
  if (this._options.attachments && test.file && test.file.length > 0) {
    let attachments = Array.isArray(test.file) ? test.file : [test.file];
    systemOutLines = systemOutLines.concat(attachments.map(
      function (attachement) {
        return '[[ATTACHMENT|' + attachement + ']]';
      }
    ));
  }
